...
freetds-bin freetds-dev git gosu graphviz graphviz-dev krb5-user ldap-utils libev4 libev-dev libffi-dev
libgeos-dev libkrb5-dev libldap2-dev libleveldb1d libleveldb-dev libsasl2-2 libsasl2-dev libsasl2-modules \
...
curl dumb-init freetds-bin gosu krb5-user libev4 libgeos-dev \
